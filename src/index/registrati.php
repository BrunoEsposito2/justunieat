...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
                ...
                <a href="#">
                    <i class="material-icons md-36 carts">shopping_cart_outline</i>
                </a>
      ...
      <div class="tab-pane fade show active col-sm-12" id="RegCli" role="tabpanel" aria-labelledby="home-tab">
        <div class="text-center" >
            <form class="form-signin" action="reg.php" method="POST">
                ...
                <input type="text" id="inputName" class="form-control" placeholder="Nome" required="true" autofocus="true">
                <label for="inputNome" class="sr-only">Cognome</label>
                <input type="text" id="inputCognome" class="form-control" placeholder="Cognome" required="true"
                    autofocus="true">
                <label for="inputCell" class="sr-only">Cellulare</label>
                <input type="tel" id="inputTel" class="form-control" placeholder="Cellulare" required="true" autofocus="true">
